...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-syde-myomote.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-syde-myomote)

This repository contains the source code for the [MyoMote](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.syde.myomote).

Please see the [issues](https://github.com.syde.myomote/com-syde-myomote/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about MyoMote? Ask away on the [com-syde-myomote discussion forum](https://groups.google.com/forum/#!forum/com-syde-myomote).

<a href="https://play.google.com/store/apps/details?id=com.syde.myomote" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.syde.myomote__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.syde.myomote__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.syde.myomote.R__) will now be renamed
...
signed with a different key.  Manually uninstall MyoMote from your device and
...
MyoMote is a result of a template project I've developed over the years as well as
...
MyoMote is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.syde.myomote/com-syde-myomote/contributors) on
...
[pull requests](https://github.com.syde.myomote/com-syde-myomote/pulls).
